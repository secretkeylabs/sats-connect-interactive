...
import CODE from "./snippets/get-info.ts?raw";

export const GetInfoExample: Component = () => {
  ...
  return (
    <InteractiveExample method="getInfo" title="Get Wallet Info" code={CODE}>
      <div class={s.buttonRow}>
        <button class={s.button} onClick={handleGetInfo} disabled={loading()}>
          Get Info
        </button>
        <Show when={loading()}>
          <Spinner />
