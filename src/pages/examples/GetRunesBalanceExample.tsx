...
import CODE from "./snippets/runes-get-balance.ts?raw";

export const GetRunesBalanceExample: Component = () => {
  ...
  return (
    <InteractiveExample
      method="runes_getBalance"
      title="Get Runes Balance"
      code={CODE}
    >
      <div class={s.buttonRow}>
        <button
          class={s.button}
          onClick={handleGetRunesBalance}
          disabled={loading()}
        >
          Get Runes Balance
        </button>
